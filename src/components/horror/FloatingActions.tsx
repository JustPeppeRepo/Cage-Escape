...
const whatsapp = SOCIAL_LINKS.find((link) => link.id === "whatsapp");
    ...
    <div className="fixed bottom-5 right-5 z-50 flex items-center gap-3 sm:bottom-6 sm:right-6">
      ...
      {whatsapp ? (
        <a
          ...
          title="WhatsApp"
          className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(0,0,0,0.45)] transition-transform hover:scale-105 hover:bg-[#20bd5a] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bone"
        >
          <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
